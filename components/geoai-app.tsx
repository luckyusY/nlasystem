    ...
    <div className="app-shell">
      <aside className={`sidebar ${sidebarOpen ? "sidebar-open" : ""}`}>
        <div className="brand-block">
          <div className="brand-mark" aria-hidden="true"><span>N</span><i /></div>
          <div><strong>NLA GeoAI</strong><small>Land intelligence workspace</small></div>
