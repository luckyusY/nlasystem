  ...
  return <div className="gnss-workspace">
    ...
    <section className="gnss-layout">
      <aside className="gnss-controls panel">
        ...
        {obstruction !== "none" && <label>Skyline height <output>{obstructionElevation}°</output><input type="range" min="15" max="70" step="5" value={obstructionElevation} onChange={(event) => setObstructionElevation(Number(event.target.value))} /></label>}
